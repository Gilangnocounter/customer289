...
const WISH_MESSAGES = [
	...
	"SEMOGA ERINA DIBERIKAN PERLINDUNGAN🩷",
	"SELAMAT ULANG TAHUN YG KE 24😍",
	"SEMOGA DIJAUHKAN DARI SEGALA PENYAKIT🥰",
	"SEMOGA KAMU JADI ANAK SOLEH💞",
	"SEMOGA CEPAT KAYA🫶🏻",
	"SEMOGA KAMU SENTIASA NAMPAK MUDA🩷"
];
...
function startIntro() {
	...
	setTimeout(() => {
		...
		setTimeout(() => {
			...
			// CUSTOM1
			setTimeout(() => {
				showIntroText('HAPPY BIRTHDAY TO MY PRETTIEST GIRL SEMOGA KAMU SENTIASA MENJADI BUDAK BAIK DAN DIBERIKAN UMUR PANJANG. SEMOGA PERTEMUAN KITA NI BERKEKALAN SAMPAI PENGHUJUNG LAA YEE 😍', false);
